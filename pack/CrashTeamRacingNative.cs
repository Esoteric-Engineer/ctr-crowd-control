...
public class CrashTeamRacingNative : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override EffectList Effects { get; } = new Effect[]
    {
        ...
        new("Remove Random Adventure Item", "adv_remove_random") { Category = "Remove Adventure Progress", Price = 15, Description = "Revoke a random already-unlocked Trophy, Relic, CTR Token, or Boss Key. Requires an active Adventure mode race." },
