...
#endif
/* native_win32.h undefines these, winsock needs them back until the bottom of this file. */
#ifndef far
#define far
#endif
#ifndef near
...
#if defined(_WIN32)
/* Restore native_win32.h's protection for the rest of this unity build. */
#undef far
#undef near
#endif
