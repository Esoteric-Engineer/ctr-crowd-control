...
CROWD_EFFECT("item_remove", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ITEM, ItemRemove)
...
CROWD_EFFECT("cheat_permanent_super_engine", CROWD_EFFECT_TIMED, 30000, CROWD_EFFECT_CATEGORY_CHEAT, CheatPermanentSuperEngine)
...
/* Adventure progress (instant, requires an active Adventure-mode race). See crowd/crowd_fx_adventure.c. */
CROWD_EFFECT("adv_add_random", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddRandom)
CROWD_EFFECT("adv_add_trophy", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddTrophy)
CROWD_EFFECT("adv_add_sapphire_relic", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddSapphireRelic)
CROWD_EFFECT("adv_add_gold_relic", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddGoldRelic)
CROWD_EFFECT("adv_add_platinum_relic", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddPlatinumRelic)
CROWD_EFFECT("adv_add_token", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddToken)
CROWD_EFFECT("adv_add_key", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvAddKey)
CROWD_EFFECT("adv_remove_random", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvRemoveRandom)
CROWD_EFFECT("adv_remove_trophy", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvRemoveTrophy)
CROWD_EFFECT("adv_remove_sapphire_relic", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvRemoveSapphireRelic)
CROWD_EFFECT("adv_remove_gold_relic", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvRemoveGoldRelic)
CROWD_EFFECT("adv_remove_platinum_relic", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvRemovePlatinumRelic)
CROWD_EFFECT("adv_remove_token", CROWD_EFFECT_INSTANT, 0, CROWD_EFFECT_CATEGORY_ADVENTURE, AdvRemoveToken)
